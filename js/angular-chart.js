...
(function (factory) {
    ...
    angular.module('chart.js', [])
            ...
            .directive('chartBase', ['ChartJsFactory', function (ChartJsFactory) {
    ...
    function ChartJsFactory(ChartJs) {
            ...
            return {
                ...
                link: function (scope, elem/*, attrs */) {
                    ...
                    scope.$watch('data', function (newVal, oldVal) {
                        ...
                        if (chart) {
                            if (canUpdateChart(newVal, oldVal))
        ...
        function createChart(type, scope, elem) {
            ...
            if (scope.legend && scope.legend !== 'false')
        ...
        function convertColour(colour) {
            ...
            if (typeof colour === 'string' && colour[0] === '#')
                return getColour(hexToRgb(colour.substr(1)));
